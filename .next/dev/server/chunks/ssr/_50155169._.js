module.exports = [
"[project]/lib/foodIndex.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildFoodIndex() {
    ...
    const foodsLite = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$foods_clean$2e$json__$28$json$29$__["default"].map((f)=>({
            id: f.id,
            name: f.name
        }));
...
"[project]/lib/foodSearch.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$foodIndex$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/foodIndex.ts [app-ssr] (ecmascript)");
;
...
function searchFoods(query, limit = 50) {
    ...
    if (!q) return [];
    const index = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$foodIndex$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildFoodIndex"])();
    const tokens = q.split(" ");
    let results = null;
    for (const token of tokens){
        const matches = index.tokenMap.get(token);
        if (!matches) return [];
        results = results ? intersect(results, matches) : matches;
    }
    if (!results) return [];
    return results.slice(0, limit).map((i)=>index.foods[i]);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$foodSearch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/foodSearch.ts [app-ssr] (ecmascript)");
...
function LogFoodPage() {
    ...
    function handleSearch(q) {
        setQuery(q);
        setResults((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$foodSearch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["searchFoods"])(q, 40)); // CHUNK SIZE
    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: results.map((f)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: ()=>{
                            setFoodId(f.id);
                            setQuery(f.name);
                            setResults([]);
...
//# sourceMappingURL=_50155169._.js.map