...
function HomePage() {
    ...
    const getNutrient = (id)=>nutrients.find((n)=>n.id === id) ?? {
            id,
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nutrientRegistry$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNutrientById"])(id)?.label ?? id,
            value: 0,
            goal: 0,
            unit: "",
            progress: 0
    ...
    const microAvg = micros.length === 0 ? 0 : Math.round(micros.reduce((sum, n)=>sum + (n.progress ?? 0), 0) / micros.length * 100) / 100;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f92ca2a4._.js.map