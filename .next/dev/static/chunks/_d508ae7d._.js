...
"[project]/lib/foodData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeFoods() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$foods_clean$2e$json__$28$json$29$__["default"].map((food)=>{
        ...
        for (const fn of food.foodNutrients ?? []){
            ...
            const nutrientDef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nutrientRegistry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNutrientByUsdaName"])(fn.nutrient.name);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$foodData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/foodData.ts [app-client] (ecmascript)");
;
;
;
;
...
async function logFood(foodId, grams) {
    ...
    const food = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$foodData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFoodById"])(foodId);
    if (!food) return;
...
function LogFoodPage() {
    ...
    const [foodId, setFoodId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    async function handleAdd() {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$nutritionEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logFood"])(foodId, Number(grams));
        router.push("/");
        router.refresh();
    }
...
_s(LogFoodPage, "d6PymzXgUrFQ+Q0yl8l1cHTuprY=", false, function() {
    return [
...
//# sourceMappingURL=_d508ae7d._.js.map